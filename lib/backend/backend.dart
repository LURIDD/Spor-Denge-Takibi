...
import 'schema/user_badges_record.dart';
...
Future<int> queryUserGoalsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      UserGoalsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserGoalsRecord>> queryUserGoalsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      UserGoalsRecord.collection(parent),
      UserGoalsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserGoalsRecord>> queryUserGoalsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryUserActivitiesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      UserActivitiesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Stream<List<GoalLogsRecord>> queryGoalLogsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<GoalLogsRecord>> queryGoalLogsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryUserBadgesRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserBadgesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserBadgesRecord>> queryUserBadgesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      UserBadgesRecord.collection(parent),
      UserBadgesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserBadgesRecord>> queryUserBadgesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
