...
class HomePageDailySummaryWidget extends StatefulWidget {
  const HomePageDailySummaryWidget({
    ...
    int? tamamlananAdet,
    int? kalanAdet,
  })  : this.tamamlananAdet = tamamlananAdet ?? 0,
        this.kalanAdet = kalanAdet ?? 0;

  final int tamamlananAdet;
  final int kalanAdet;

  @override
  State<HomePageDailySummaryWidget> createState() =>
      _HomePageDailySummaryWidgetState();
}

class _HomePageDailySummaryWidgetState
    extends State<HomePageDailySummaryWidget> {
  late HomePageDailySummaryModel _model;
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        widget.tamamlananAdet.toString(),
