...
class WaterSenseiWidget extends StatefulWidget {
  ...
  @override
  State<WaterSenseiWidget> createState() => _WaterSenseiWidgetState();
}

class _WaterSenseiWidgetState extends State<WaterSenseiWidget> {
  late WaterSenseiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WaterSenseiModel());
  }
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF1E6AFE), Color(0xFF4A9BFF)],
                      stops: [0.0, 1.0],
