              ...
              Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/hareketli_cake.gif',
                      width: 75.0,
                      height: 75.0,
                      fit: BoxFit.cover,
                    ),
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          final _datePickedDate = await showDatePicker(
                            context: context,
                            initialDate:
                                DateTime.now().subtract(Duration(days: 4748)),
                            firstDate: (DateTime.now()
                                    .subtract(Duration(days: 36525)) ??
                                DateTime(1900)),
                            lastDate: (DateTime.now()
                                    .subtract(Duration(days: 4748)) ??
                                DateTime(2050)),
                          ...
                          FFAppState().TempBirthDate = _model.datePicked;
                          safeSetState(() {});

                          context.pushNamed(
                            HeightAndWeightPageWidget.routeName,
