...
class FirstLaunchPageWidget extends StatefulWidget {
  ...
  static String routeName = 'FirstLaunchPage';
  static String routePath = '/firstLaunchPage';

  @override
  State<FirstLaunchPageWidget> createState() => _FirstLaunchPageWidgetState();
}

class _FirstLaunchPageWidgetState extends State<FirstLaunchPageWidget>
    with TickerProviderStateMixin {
  late FirstLaunchPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirstLaunchPageModel());
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    'Küçük adımlarla başlayıp, her gün kendi rekorunu kırmak için hazırsan, ',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
