...
class _SignUpWidgetState extends State<SignUpWidget>
  ...
  void initState() {
    ...
    _model.passwordVerifyTextController ??= TextEditingController();
    _model.passwordVerifyFocusNode ??= FocusNode();
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.passwordVerifyFocusNode,
                                          autofocus: true,
                                          autofillHints: [
                                            AutofillHints.password
                                          ],
                                          obscureText:
                                              !_model.passwordVerifyVisibility,
                                          decoration: InputDecoration(
                                          ...
                                          validator: _model
                                              .passwordVerifyTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                        ...
                                        onPressed: () async {
                                          if (_model.passwordTextController
                                              ...
                                              _model
                                                  .passwordVerifyTextController
                                                  .text) {
                                            FFAppState().tempEmail = _model
                                                .emailAddressTextController
                                                .text;
                                            FFAppState().tempPassword = _model
                                    ...
                                    Padding(
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: 'Zaten kayıt oldun mu? ',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text: 'Buradan giriş yap',
