...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.displayNameTxtTextController ??=
        TextEditingController(text: currentUserDisplayName);
    _model.displayNameTxtFocusNode ??= FocusNode();

    _model.displayNameTxtMask = MaskTextInputFormatter(mask: 'aaaaaaaaaaaaa');
    _model.userAgeTxtTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userAge, 0).toString());
    _model.userAgeTxtFocusNode ??= FocusNode();

    _model.userHeightTxtTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userHeight, 0.0).toString());
    _model.userHeightTxtFocusNode ??= FocusNode();

    _model.userWeightTxtTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.userWeight, 0.0).toString());
    _model.userWeightTxtFocusNode ??= FocusNode();
  }
              ...
              child: Column(
                ...
                children: [
                            ...
                            Align(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => Container(
                                  width: double.infinity,
                                  child: TextFormField(
                                    controller: _model.userAgeTxtTextController,
                                    focusNode: _model.userAgeTxtFocusNode,
                                    autofocus: false,
                                    enabled: true,
                                    readOnly: true,
                                    obscureText: false,
                                    ...
                                    enableInteractiveSelection: true,
                                    validator: _model
                                        .userAgeTxtTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                  ...
                  Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      // Kullanicinin boy bilgisini girdigi alan
                      Expanded(
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) => Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .userHeightTxtTextController,
                                                focusNode: _model
                                                    .userHeightTxtFocusNode,
                                                autofocus: false,
                                                enabled: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                ...
                                                enableInteractiveSelection:
                                                    true,
                                                validator: _model
                                                    .userHeightTxtTextControllerValidator
                                                    .asValidator(context),
                                                inputFormatters: [
                      ...
                      // Kullanicinin kilo bilgisini girdigi alan
                      Expanded(
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) => Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .userWeightTxtTextController,
                                                focusNode: _model
                                                    .userWeightTxtFocusNode,
                                                autofocus: false,
                                                enabled: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                ...
                                                enableInteractiveSelection:
                                                    true,
                                                validator: _model
                                                    .userWeightTxtTextControllerValidator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  FilteringTextInputFormatter
                                                      .allow(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child:
                          // Edit profilde yapilan degisikliklerin kaydedildigi alan
                          Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
